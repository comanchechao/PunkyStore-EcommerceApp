<template>
  <div class="">
    <button
      @click="openModal"
      class="bg-mainYellow w-8 h-8 lg:w-8 lg:h-8 shadow-2xl rounded-xl"
    >
      <button>
        ...
        <div class="min-h-screen px-4 text-center">
          ...
          >
            ...
            >
              <DialogTitle
                as="div"
                class="flex flex-row justify-center text-lg font-medium leading-6"
              >
                <button
                  @click="tab = 'product'"
              ...
              <div class="p-2">
                ...
                >
                  <div class="flex flex-wrap flex-col justify-center p-5">
                    <div
                      class="bg-Amber-500 flex justify-center rounded p-4 font-bold text-white"
                    >
                      <h1>ویرایش کالا</h1>
                    </div>
                    <div
