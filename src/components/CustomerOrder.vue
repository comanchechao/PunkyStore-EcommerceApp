<template>
  ...
  >
    <div
      :class="{
        'bg-Amber-500': displayedTab === 'SentOrders',
        'bg-blue-500 text-white hover:bg-blue-700':
          displayedTab === 'AllOrders',
      }"
      class="date bg-mainGreen text-black px-4 py-2 rounded flex"
    >
      2022/2/2
    </div>
    <div
      ...
      <Menu as="div" class="relative inline-block text-right mr-2">
        <div class="flex w-full flex-row justify-center align-center">
          <MenuButton
            ...
            class="menuButton inline-flex w-full flex-row-reverse justify-between align-center transition ease-in duration-200 w-full px-4 py-2 text-sm font-medium text-white bg-mainGreen rounded-md hover:bg-Sky-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
          >
            <div class="flex text-black text-lg font-black hover:text-white">
              <h1
                :class="{
                  ' text-white': displayedTab === 'AllOrders',
                }"
        ...
        >
          <MenuItems
            class="absolute text-right top-0 right-8 w-56 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          >
            <div class="menuItems px-1 py-1 w-full">
    ...
    <div class="orderInfo">
      <Menu as="div" class="relative inline-block text-right mr-2">
        ...
        >
          <MenuItems
            class="absolute text-right z-20 top-20 w-56 mt-2 origin-bottom-center bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          >
            <div class="menuItems px-1 py-1 w-full">
              <MenuItem v-slot="{ active }">
                <DefaultButton
